...
root ='C:/Users/user/Desktop/duygu_tanima/'
#------------------------------
#değişkenler
...
if fit == False:
    ...
    #rastgele bir eğtiim yap
     model=model.save(root + 'yüklenen.h5')
else:
	  model.load_weights( root + 'yüklenen.h5')
#------------------------------

test_img_path = root + "5.jpg"
